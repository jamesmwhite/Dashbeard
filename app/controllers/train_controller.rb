			...
			for full in regresults
				...
				if not singletrain.empty?
					...
					if not stationDeptTime.empty?
						...
						trainsArr.push "<div class=\"train-time-line\"><div class=\"train-departing\">Departing: <span class=\"livetime\">#{stationDeptTime}</span></div><div class=\"journey-time\">#{journeyWithoutTime}</div></div>"
